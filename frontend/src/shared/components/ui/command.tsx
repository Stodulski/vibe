    ...
    <Dialog {...props}>
      <DialogContent className={cn('overflow-hidden p-0', className)} showCloseButton={showCloseButton}>
        {/*
          ...
          open: DialogContent is gated by Radix's own open-state Presence,
          but a plain sibling div is not, so the old placement kept an
          sr-only "Command Palette" heading sitting in the DOM at all times,
