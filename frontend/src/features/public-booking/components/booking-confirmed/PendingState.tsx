...
export function PendingState() {
  return (
    <div className="flex flex-col items-center gap-5 py-16">
      ...
      <p className="text-text-primary text-lg font-semibold">{t.publicBooking.processingPayment}</p>
      <p className="text-text-secondary text-sm">{t.publicBooking.bookingPending}</p>
