...
export function PendingState() {
  return (
    <div className="flex flex-col items-center gap-5 py-16">
      ...
      <p className="text-lg font-semibold text-text-primary">{t.publicBooking.processingPayment}</p>
      <p className="text-sm text-text-secondary">{t.publicBooking.bookingPending}</p>
