 ...
 * today's collected booking revenue across every method, which is not a cash
 * control — the till (open/closed, expected cash) lives on the Caja screen.
 * "Ingresos de hoy" says what this figure actually is.
 */
