...
// reservedSlugs is every first-path-segment route vibe-client's router
// declares statically, ahead of its own catch-all `/:slug` page — see
// vibe-client/src/app/router.tsx, which lists authRoutes, ownerStandaloneRoutes,
...
//
// This is a fact about a different repository (vibe-client) living in this
...
var reservedSlugs = map[string]bool{
	...
	// Platform paths, from vibe-client/middleware.ts's SKIP_PREFIXES rather
