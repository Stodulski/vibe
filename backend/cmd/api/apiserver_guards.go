...
var routeGuards = map[string]routeGuard{
	...
	"GET /api/v1/complexes/{id}/cash-session":                          {kind: guardOwner},
	"GET /api/v1/complexes/{id}/cash-sessions":                         {kind: guardOwner},
	"POST /api/v1/complexes/{id}/cash-sessions":                        {kind: guardOwner, idempotentKey: "cashbox-open"},
	"GET /api/v1/complexes/{id}/cash-sessions/{sessionID}":             {kind: guardOwner},
	"POST /api/v1/complexes/{id}/cash-sessions/{sessionID}/close":      {kind: guardOwner, idempotentKey: "cashbox-close"},
	"POST /api/v1/complexes/{id}/cash-sessions/{sessionID}/movements":  {kind: guardOwner, idempotentKey: "cashbox-movement"},
	"POST /api/v1/complexes/{id}/cash-sessions/{sessionID}/movements/{movementID}/void": {kind: guardOwner, idempotentKey: "cashbox-void"},
	...
	"GET /api/v1/complexes/{id}/products":                                               {kind: guardOwner},
	"POST /api/v1/complexes/{id}/products":                                              {kind: guardOwner, idempotentKey: "products-create"},
	"GET /api/v1/complexes/{id}/products/{productID}":                                   {kind: guardOwner},
	"PATCH /api/v1/complexes/{id}/products/{productID}":                                 {kind: guardOwner, idempotentKey: "products-update"},
	"POST /api/v1/complexes/{id}/products/{productID}/adjustments":                      {kind: guardOwner, idempotentKey: "products-adjust"},
	"POST /api/v1/complexes/{id}/products/{productID}/restock":                          {kind: guardOwner, idempotentKey: "products-restock"},
	"GET /api/v1/complexes/{id}/products/{productID}/stock-movements":                   {kind: guardOwner},
	"GET /api/v1/complexes/{id}/sales":                                                  {kind: guardOwner},
	"POST /api/v1/complexes/{id}/sales":                                                 {kind: guardOwner, idempotentKey: "sales-create"},
	"GET /api/v1/complexes/{id}/sales/{saleID}":                                         {kind: guardOwner},
	"POST /api/v1/complexes/{id}/sales/{saleID}/void":                                   {kind: guardOwner, idempotentKey: "sales-void"},
