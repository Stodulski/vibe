 ...
 * (vibe-server removed the version counter). A concurrent write is refused inside the
...
export interface UpdateBookingRequest {
  ...
  /**
   * The two payment axes are sent separately (vibe-server split payment_status). The
